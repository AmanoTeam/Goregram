    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public int getItemViewType(int position) {
            if (emptyRows.contains(position)) {
                return 1;
            } else if (position == customTitleRow || position == hiddenAccountsRow || position == cloudflareSTTRow || position == voiceQualityRow || position == lastFmLoginRow || position == exportSettingsRow || position == importSettingsRow) {
                return 2;
